...
public class OpenTelemetryTracerBuilderObsolete implements TracerBuilder<OpenTelemetryTracerBuilderObsolete> {

    static final boolean DEFAULT_ENABLED = true;
    private static final System.Logger LOGGER = System.getLogger(OpenTelemetryTracerBuilderObsolete.class.getName());
     ...
     */
    public OpenTelemetryTracerBuilderObsolete openTelemetry(OpenTelemetry ot) {
        this.ot = ot;
        return this;
    }

    @Override
    public OpenTelemetryTracerBuilderObsolete serviceName(String name) {
    ...
    public OpenTelemetryTracerBuilderObsolete spanExporters(Map<String, SpanExporterConfiguration> spanExporters) {
     ...
     * @return updated builder
     */
    public OpenTelemetryTracerBuilderObsolete addSpanExporter(String exporterName, SpanExporter spanExporter) {
     ...
     * @return updated builder
     */
    public OpenTelemetryTracerBuilderObsolete addSpanExporter(String exporterName, SpanExporterConfiguration spanExporterConfig) {
        verifyUniqueSpanExporterName(exporterName);
     ...
     */
    @ConfiguredOption
    public OpenTelemetryTracerBuilderObsolete spanProcessors(List<SpanProcessorConfiguration> spanProcessorConfigs) {
     ...
     * @return updated builder
     */
    public OpenTelemetryTracerBuilderObsolete addSpanProcessor(SpanProcessor spanProcessor) {
     ...
     * @return updated builder
     */
    public OpenTelemetryTracerBuilderObsolete addSpanProcessor(SpanProcessorConfiguration spanProcessorConfig) {
        spanProcessorConfigs.add(spanProcessorConfig);
        return this;
    }

    @Override
    public OpenTelemetryTracerBuilderObsolete collectorProtocol(String protocol) {
     ...
     */
    public OpenTelemetryTracerBuilderObsolete exporterProtocol(OtlpExporterProtocol otlpExporterProtocol) {
        this.otlpExporterProtocol = otlpExporterProtocol;
        return this;
    }

    @Override
    public OpenTelemetryTracerBuilderObsolete collectorPort(int port) {
        exporterPort = port;
        return this;
    }

    @Override
    public OpenTelemetryTracerBuilderObsolete collectorHost(String host) {
        exporterHost = host;
        return this;
    }

    @Override
    public OpenTelemetryTracerBuilderObsolete collectorPath(String path) {
        exporterPath = path;
        return this;
    }

    @Override
    public OpenTelemetryTracerBuilderObsolete addTracerTag(String key, String value) {
        tags.put(key, value);
        return this;
    }

    @Override
    public OpenTelemetryTracerBuilderObsolete addTracerTag(String key, Number value) {
        tags.put(key, String.valueOf(value));
        return this;
    }

    @Override
    public OpenTelemetryTracerBuilderObsolete addTracerTag(String key, boolean value) {
        tags.put(key, String.valueOf(value));
        return this;
    }

    @Override
    public OpenTelemetryTracerBuilderObsolete config(Config tracingConfig) {
    ...
    @Override
    public OpenTelemetryTracerBuilderObsolete enabled(boolean enabled) {
        this.enabled = enabled;
        return this;
    }

    @Override
    public OpenTelemetryTracerBuilderObsolete registerGlobal(boolean global) {
        this.global = global;
        return this;
    }
    ...
    public OpenTelemetryTracerBuilderObsolete addPropagation(ContextPropagation format) {
     ...
     */
    @ConfiguredOption
    public OpenTelemetryTracerBuilderObsolete spanExporterType(ExporterType exporterType) {
     ...
     */
    @ConfiguredOption
    public OpenTelemetryTracerBuilderObsolete exporterTimeout(Duration timeout) {
     ...
     */
    @ConfiguredOption
    public OpenTelemetryTracerBuilderObsolete compression(String compression) {
     ...
     */
    @ConfiguredOption
    public OpenTelemetryTracerBuilderObsolete headers(Map<String, String> headers) {
        this.headers.clear();
     ...
     * @return updated builder
     */
    public OpenTelemetryTracerBuilderObsolete addHeader(String name, String value) {
    ...
    public OpenTelemetryTracerBuilderObsolete samplerType(SamplerType samplerType) {
     ...
     */
    @ConfiguredOption
    public OpenTelemetryTracerBuilderObsolete samplerParam(Number samplerParam) {
     ...
     */
    @ConfiguredOption
    public OpenTelemetryTracerBuilderObsolete scheduleDelay(Duration scheduleDelay) {
     ...
     */
    @ConfiguredOption
    public OpenTelemetryTracerBuilderObsolete maxQueueSize(int maxQueueSize) {
     ...
     */
    @ConfiguredOption
    public OpenTelemetryTracerBuilderObsolete maxExportBatchSize(int maxExportBatchSize) {
    ...
    public OpenTelemetryTracerBuilderObsolete privateKey(io.helidon.common.configurable.Resource resource) {
    ...
    public OpenTelemetryTracerBuilderObsolete clientCertificate(io.helidon.common.configurable.Resource resource) {
    ...
    public OpenTelemetryTracerBuilderObsolete trustedCertificates(io.helidon.common.configurable.Resource resource) {
    ...
    public OpenTelemetryTracerBuilderObsolete spanProcessorType(SpanProcessorType spanProcessorType) {
