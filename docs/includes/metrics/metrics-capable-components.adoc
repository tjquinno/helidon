...
ifdef::se-flavor[:tjq-se: se-flavor was assigned]
ifdef::mp-flavor[:tjq-mp: mp-flavor was assigned]
ifndef::se-flavor,mp-flavor[:se-flavor: true]
...
* tjq-se is {tjq-se}
* tjq-mp is {tjq-mp}
* h1-prefix is {h1-prefix}
* intro-project-name is {intro-project-name}
