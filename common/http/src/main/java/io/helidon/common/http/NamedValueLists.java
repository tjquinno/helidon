...
interface NamedValueLists<T extends NamedValueLists<T>> extends Iterable<Map.Entry<String, List<String>>> {

    /**
     * Returns an {@link java.util.Optional} containing the first value of the given
     ...
     * @throws UnsupportedOperationException if put operation is not supported (unmodifiable Parameters).
     */
    T add(String key, String... values);
     ...
     * @throws UnsupportedOperationException if put operation is not supported (unmodifiable Parameters).
     */
    T add(String key, Iterable<String> values);
    ...
    /**
     * Returns an iterator over the entries in the data. Implementations should override this default
